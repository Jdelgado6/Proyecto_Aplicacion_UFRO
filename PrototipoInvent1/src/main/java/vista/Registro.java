...
public class Registro extends javax.swing.JFrame {
    ...
    private Date fecha;
    private RegistroProductos producto;
    ...
    void mostrarTabla(String valor) {
        ...
        String sql = "SELECT * FROM producto WHERE CONCAT (nombre,' ',id_categoria_producto,' ',id_registro_producto) LIKE'%" + valor + "%'";
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error al generar tabla de datos");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Registro movimientos");
        ...
        jLabel2.setText("Buscar por usuario:");
